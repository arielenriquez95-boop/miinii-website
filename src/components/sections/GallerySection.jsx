    ...
    <SectionScrollReveal id="gallery" className="bg-[#070B18] py-16 text-white sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <div
            ref={carouselRef}
            className={`snap-x snap-mandatory overflow-x-auto overscroll-x-contain scroll-smooth py-2 [overflow-clip-margin:2.5rem] [scrollbar-width:none] [-ms-overflow-style:none] px-6 sm:px-8 lg:overscroll-y-auto lg:px-4 [&::-webkit-scrollbar]:hidden ${MOBILE_CAROUSEL_TOUCH_CLASS}`}
          >
