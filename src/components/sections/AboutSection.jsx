          ...
          <SectionContentReveal delay={120} direction="left" className="relative lg:col-span-5 xl:col-span-5">
            <div className="relative mx-auto w-full max-w-[380px]">
              ...
              <div className="relative flex justify-center pb-6">
                ...
                <div className="relative size-64 overflow-hidden rounded-full border-4 border-white bg-white shadow-[0_24px_60px_rgba(15,23,42,0.14)] ring-1 ring-slate-200/80 xl:size-72">
                  <img src="/about-portrait.png" alt="Miinii artist portrait" className="h-full w-full object-cover object-top" />
                </div>

                <div className="absolute -bottom-1 left-1/2 flex -translate-x-1/2 items-center gap-2 rounded-full border border-white/80 bg-white/95 px-5 py-2.5 shadow-lg shadow-slate-900/10 backdrop-blur">
