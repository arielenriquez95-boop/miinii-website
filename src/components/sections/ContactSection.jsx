...
export function ContactSection() {
  return (
    <SectionScrollReveal id="contact" className="px-4 pb-8 sm:px-6 lg:px-8">
      <SectionContentReveal delay={120}>
          ...
          <div className="mx-auto flex max-w-4xl flex-col items-center">
            ...
            <div className="mt-8 grid w-full max-w-4xl grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {socialLinks.map((link, index) => (
                <SectionContentReveal key={link.href} delay={280 + index * 70} className="h-full w-full">
                  <a
                    href={link.href}
                    target="_blank"
            ...
            <SectionContentReveal delay={560} className="mt-7 w-full sm:mt-8">
              <div className="flex flex-col items-center gap-2 text-center text-sm leading-6 text-white/90 sm:text-base sm:leading-7">
