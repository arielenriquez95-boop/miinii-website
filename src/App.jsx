    ...
    <main className="min-h-screen overflow-hidden bg-[#fff8f3] text-slate-900 [scroll-behavior:smooth]">
      ...
      <section id="about" className="relative overflow-hidden bg-white py-16 sm:py-24">
        ...
        <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8"><Reveal><div className="overflow-hidden rounded-[2rem] border border-slate-100 bg-[#fff8f3] shadow-[0_18px_60px_rgba(15,23,42,0.08)]"><div className="grid gap-0 md:grid-cols-[0.85fr_1.15fr]">
          ...
          <div className="flex flex-col justify-center p-6 sm:p-10 lg:p-12"><p className="mb-3 text-sm font-bold uppercase tracking-[0.25em] text-[#16C1C1]">About us</p><h2 className="text-4xl font-black tracking-tight text-slate-950 sm:text-5xl">Meet the artist behind Miinii.</h2><p className="mt-5 text-lg leading-8 text-slate-600">Hi, I’m Ariel, the creator of Miinii Studios. Miinii started from my love for 3D art, design, and meaningful custom gifts. What began as a creative idea became a small studio that turns real people, pets, and special memories into handcrafted 3D mini figures.</p><p className="mt-4 text-base leading-7 text-slate-500">Each Miinii goes through a careful process — from digital sculpting, resin 3D printing, sanding, hand painting, finishing, and packaging. Every detail is made with care so the final piece feels personal, gift-ready, and truly one of a kind.</p><p className="mt-4 text-base leading-7 text-slate-500">As Miinii continues to grow, we’re also working toward building a bigger creative team that can accommodate more custom Miinii creations for everyone. Our goal is to make personalized 3D mini figures more accessible while keeping the same care, quality, and handmade feel in every piece.</p></div>
        </div></div></Reveal></div>
      </section>
