    ...
    <div className="min-h-screen bg-white text-zinc-900">
      <header className="sticky top-0 z-50 border-b border-zinc-100 bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-3 md:px-6 md:py-4">
          ...
          <a
            href="#contact"
            className="rounded-full bg-[#ef6a30] px-4 py-2 text-xs font-semibold text-white shadow-sm transition hover:scale-[1.02] md:px-5 md:py-2.5 md:text-sm"
          >
            Order Now
          </a>
        </div>
      ...
      <main>
        <section className="relative overflow-hidden">
          ...
          <div className="relative mx-auto grid max-w-7xl gap-8 px-5 pb-14 pt-12 md:grid-cols-2 md:items-center md:gap-10 md:px-6 md:py-28">
            <div className="text-center md:text-left">
              <div className="mb-4 inline-flex max-w-full rounded-full border border-[#1fb7a6]/20 bg-[#1fb7a6]/10 px-4 py-1.5 text-xs font-medium text-[#138b80] md:text-sm">
                Personalized keepsakes made into mini art
              </div>

              <h1 className="mx-auto max-w-md text-[2.4rem] font-black leading-[1.05] tracking-tight sm:text-5xl md:mx-0 md:max-w-xl md:text-6xl">
                Turn your photos into{" "}
                <span className="text-[#ef6a30]">
                  custom 3D mini figures
                </span>
              </h1>
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:justify-center md:justify-start">
                ...
                <a
                  href="#how-it-works"
                  className="rounded-full border border-zinc-200 bg-white px-7 py-3.5 text-center font-semibold text-zinc-700 transition hover:border-[#1fb7a6] hover:text-[#1fb7a6]"
                >
                  See the Process
                </a>
              </div>
              ...
              <div className="mt-8 grid gap-3 text-center text-sm text-zinc-500 sm:grid-cols-3 md:text-left">
                <div className="rounded-2xl bg-white/70 p-3 shadow-sm ring-1 ring-zinc-100 md:bg-transparent md:p-0 md:shadow-none md:ring-0">
            ...
            <div className="grid gap-4 md:pl-10">
              <div className="mx-auto w-full max-w-[360px] overflow-hidden rounded-[1.75rem] md:max-w-none md:rounded-[2rem]">
                <img
                  src="/hero-image.png"
              ...
              <div className="grid gap-3 sm:grid-cols-3 md:gap-4">
                <div className="rounded-3xl border border-zinc-100 bg-white p-4 text-center shadow-sm md:text-left">
                  <div className="text-xl font-black text-[#ef6a30] md:text-2xl">
                    100%
                  </div>
                  <p className="mt-1 text-xs leading-5 text-zinc-600 md:text-sm">
                    customized from your references
                  </p>
                </div>

                <div className="rounded-3xl border border-zinc-100 bg-white p-4 text-center shadow-sm md:text-left">
                  <div className="text-xl font-black text-[#1fb7a6] md:text-2xl">
                    2–4 weeks
                  </div>
                  <p className="mt-1 text-xs leading-5 text-zinc-600 md:text-sm">
                ...
                <div className="rounded-3xl border border-zinc-100 bg-white p-4 text-center shadow-sm md:text-left">
                  <div className="text-xl font-black text-zinc-900 md:text-2xl">
                    Gift-ready
                  </div>
                  <p className="mt-1 text-xs leading-5 text-zinc-600 md:text-sm">
                    signature Miinii packaging
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="about" className="mx-auto max-w-7xl px-5 py-14 md:px-6 md:py-20">
          <div className="grid gap-10 md:grid-cols-[1.1fr_0.9fr] md:items-center">
            <div>
              <div className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-[#1fb7a6]">
                About Miinii
              </div>
              ...
              <p className="mt-4 max-w-2xl text-base leading-7 text-zinc-600 md:text-lg md:leading-8">
                From digital sculpting to resin printing and hand painting, the
                process is focused on detail, character, and a premium
                custom-made feel.
              </p>
            </div>

            <div className="rounded-[2rem] bg-zinc-50 p-5 md:p-8">
              <div className="grid gap-5 sm:grid-cols-2">
                <div className="rounded-3xl bg-white p-5 shadow-sm">
                  <div className="text-3xl">🎁</div>
                  <div className="mt-3 font-bold">Meaningful gift</div>
                  <p className="mt-2 text-sm leading-6 text-zinc-600">
                    Perfect for special occasions and sentimental keepsakes.
                  </p>
                </div>
                ...
                <div className="rounded-3xl bg-white p-5 shadow-sm">
                  ...
                  <p className="mt-2 text-sm leading-6 text-zinc-600">
                    Carefully painted for a crafted and premium look.
                  </p>
                </div>
                ...
                <div className="rounded-3xl bg-white p-5 shadow-sm">
                  ...
                  <p className="mt-2 text-sm leading-6 text-zinc-600">
                    Based on your real reference photos and ideas.
                  </p>
                </div>
                ...
                <div className="rounded-3xl bg-white p-5 shadow-sm">
                  ...
                  <p className="mt-2 text-sm leading-6 text-zinc-600">
                    Finished with packaging made for gifting and display.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="how-it-works" className="bg-zinc-50 py-14 md:py-20">
          <div className="mx-auto max-w-7xl px-5 md:px-6">
            <div className="max-w-2xl">
              <div className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-[#ef6a30]">
                How it works
              </div>
              <h2 className="text-3xl font-black tracking-tight md:text-4xl">
            ...
            <div className="mt-10 grid gap-5 md:mt-12 md:grid-cols-2 xl:grid-cols-4">
              {steps.map((step) => (
                ...
                >
                  <div className="text-sm font-black tracking-[0.18em] text-[#1fb7a6]">
                    {step.num}
                  </div>
        ...
        <section id="products" className="mx-auto max-w-7xl px-5 py-14 md:px-6 md:py-20">
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-base leading-7 text-zinc-600 md:text-lg md:leading-8">
                Offer customized options for people, pets, pairs, and stylized
                concepts.
              </p>
            </div>

            <div className="rounded-3xl bg-[#ef6a30]/10 px-4 py-3 text-sm font-medium text-[#ef6a30] md:rounded-full md:py-2">
          ...
          <div className="mt-10 grid gap-5 md:mt-12 md:grid-cols-2 xl:grid-cols-4">
            {products.map((item) => (
              ...
              >
                ...
                <div className="mt-1 text-sm font-medium text-[#1fb7a6]">
                  {item.subtitle}
                </div>
                <p className="mt-4 leading-7 text-zinc-600 md:min-h-[96px]">
                  {item.desc}
                </p>
                <div className="mt-6 font-semibold text-[#ef6a30]">
                  {item.price}
                </div>
              </div>
            ))}
          ...
          <div className="mx-auto max-w-7xl px-5 md:px-6">
            <div className="grid gap-10 md:grid-cols-[0.95fr_1.05fr] md:items-center">
              <div>
                ...
                <p className="mt-5 text-base leading-7 text-zinc-300 md:text-lg md:leading-8">
          ...
          <div className="rounded-[2rem] bg-gradient-to-r from-[#fff4ef] to-[#ecfffb] p-5 md:rounded-[2.25rem] md:p-12">
            <div className="grid gap-8 md:grid-cols-2 md:items-center">
              <div>
                ...
                <p className="mt-4 max-w-xl text-base leading-7 text-zinc-600 md:text-lg md:leading-8">
              ...
              <div className="grid grid-cols-2 gap-3 md:gap-4">
                <div className="aspect-square rounded-[1.5rem] bg-white p-3 shadow-sm md:rounded-[1.75rem] md:p-4">
                  <div className="flex h-full items-center justify-center rounded-[1.25rem] border border-dashed border-zinc-200 text-sm text-zinc-400">
                    Photo 1
                  </div>
                </div>
        ...
        <section id="contact" className="mx-auto max-w-7xl px-5 py-14 md:px-6 md:py-20">
          <div className="grid gap-8 rounded-[2rem] bg-zinc-950 p-6 text-white md:grid-cols-[1fr_0.9fr] md:rounded-[2.25rem] md:p-12">
            <div>
              <div className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-[#1fb7a6]">
                Contact / Order
              </div>
              ...
              <p className="mt-5 max-w-xl text-base leading-7 text-zinc-300 md:text-lg md:leading-8">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <a
                  ...
                  className="rounded-full bg-[#ef6a30] px-6 py-3 text-center font-semibold text-white"
                >
                  Message on Facebook
                </a>
                <a
                  href="https://instagram.com"
                  className="rounded-full border border-white/15 px-6 py-3 text-center font-semibold text-white"
                >
                  View Instagram
                </a>
              </div>
            ...
            <div className="rounded-[1.75rem] bg-white p-5 text-zinc-900 md:p-6">
              ...
              <div className="mt-6 space-y-4">
                <div className="rounded-2xl bg-zinc-50 p-4">
                  ...
                  <div className="mt-1 font-medium">your@email.com</div>
                </div>
      ...
      <footer className="border-t border-zinc-100 bg-white">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-5 py-8 text-center text-sm text-zinc-500 md:flex-row md:items-center md:justify-between md:px-6 md:text-left">
          <div>
            <span className="font-bold text-zinc-900">Miinii</span> — 3D
            custom mini figures
          </div>
