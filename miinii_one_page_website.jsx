    ...
    <div className="min-h-screen bg-white text-zinc-900">
      <header className="sticky top-0 z-50 border-b border-zinc-100 bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <div>
            <div className="text-2xl font-black tracking-tight text-[#ef6a30]">Miinii</div>
            <div className="text-xs text-zinc-500">3D custom mini figures</div>
          </div>
          ...
          <a
            href="#contact"
            className="rounded-full bg-[#ef6a30] px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:scale-[1.02]"
          >
            Order Now
          </a>
        </div>
      ...
      <main>
        ...
        <section id="about" className="mx-auto max-w-7xl px-6 py-20">
          <div className="grid gap-10 md:grid-cols-[1.1fr_0.9fr] md:items-center">
            <div>
              <div className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-[#1fb7a6]">About Miinii</div>
              <h2 className="text-3xl font-black tracking-tight md:text-4xl">A custom figure made to feel personal, memorable, and display-worthy</h2>
            ...
            <div className="rounded-[2rem] bg-zinc-50 p-8">
        ...
        <section id="how-it-works" className="bg-zinc-50 py-20">
          <div className="mx-auto max-w-7xl px-6">
            <div className="max-w-2xl">
              <div className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-[#ef6a30]">How it works</div>
              <h2 className="text-3xl font-black tracking-tight md:text-4xl">From your photos to a finished Miinii</h2>
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
              {steps.map((step) => (
                <div key={step.num} className="rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-zinc-100">
        ...
        <section id="products" className="mx-auto max-w-7xl px-6 py-20">
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              <div className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-[#1fb7a6]">Products</div>
              <h2 className="text-3xl font-black tracking-tight md:text-4xl">Choose the Miinii that fits your story</h2>
              <p className="mt-4 text-lg leading-8 text-zinc-600">
                Offer customized options for people, pets, pairs, and stylized concepts.
              </p>
            </div>
            <div className="rounded-full bg-[#ef6a30]/10 px-4 py-2 text-sm font-medium text-[#ef6a30]">
              Final pricing may vary depending on details and complexity
            </div>
          </div>
          <div className="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            {products.map((item) => (
              <div key={item.title} className="group rounded-[2rem] border border-zinc-100 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
                ...
                <p className="mt-4 min-h-[96px] leading-7 text-zinc-600">{item.desc}</p>
        ...
        <section className="bg-zinc-950 py-20 text-white">
          <div className="mx-auto max-w-7xl px-6">
            <div className="grid gap-10 md:grid-cols-[0.95fr_1.05fr] md:items-center">
              <div>
                <div className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-[#1fb7a6]">Why people love Miinii</div>
                <h2 className="text-3xl font-black tracking-tight md:text-4xl">More than a figure — it’s a keepsake with personality</h2>
              ...
              <div className="grid gap-5 sm:grid-cols-3">
                {testimonials.map((item) => (
                  <div key={item.name} className="rounded-[2rem] border border-white/10 bg-white/5 p-5 backdrop-blur">
        ...
        <section className="mx-auto max-w-7xl px-6 py-20">
          <div className="rounded-[2.25rem] bg-gradient-to-r from-[#fff4ef] to-[#ecfffb] p-8 md:p-12">
            <div className="grid gap-8 md:grid-cols-2 md:items-center">
              <div>
                <div className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-[#ef6a30]">Gallery</div>
                <h2 className="text-3xl font-black tracking-tight md:text-4xl">Show your best custom works here</h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="aspect-square rounded-[1.75rem] bg-white p-4 shadow-sm"><div className="flex h-full items-center justify-center rounded-[1.25rem] border border-dashed border-zinc-200 text-zinc-400">Photo 1</div></div>
                <div className="aspect-square rounded-[1.75rem] bg-white p-4 shadow-sm"><div className="flex h-full items-center justify-center rounded-[1.25rem] border border-dashed border-zinc-200 text-zinc-400">Photo 2</div></div>
                <div className="aspect-square rounded-[1.75rem] bg-white p-4 shadow-sm"><div className="flex h-full items-center justify-center rounded-[1.25rem] border border-dashed border-zinc-200 text-zinc-400">Photo 3</div></div>
                <div className="aspect-square rounded-[1.75rem] bg-white p-4 shadow-sm"><div className="flex h-full items-center justify-center rounded-[1.25rem] border border-dashed border-zinc-200 text-zinc-400">Photo 4</div></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="faq" className="bg-zinc-50 py-20">
          <div className="mx-auto max-w-4xl px-6">
            <div className="text-center">
              <div className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-[#1fb7a6]">FAQ</div>
              <h2 className="text-3xl font-black tracking-tight md:text-4xl">Common questions</h2>
            </div>
            <div className="mt-12 space-y-4">
              {faqs.map((item) => (
                <div key={item.q} className="rounded-[1.75rem] bg-white p-6 shadow-sm ring-1 ring-zinc-100">
        ...
        <section id="contact" className="mx-auto max-w-7xl px-6 py-20">
          <div className="grid gap-8 rounded-[2.25rem] bg-zinc-950 p-8 text-white md:grid-cols-[1fr_0.9fr] md:p-12">
            <div>
              <div className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-[#1fb7a6]">Contact / Order</div>
              <h2 className="text-3xl font-black tracking-tight md:text-4xl">Ready to create your Miinii?</h2>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <a href="https://facebook.com" className="rounded-full bg-[#ef6a30] px-6 py-3 font-semibold text-white">Message on Facebook</a>
                <a href="https://instagram.com" className="rounded-full border border-white/15 px-6 py-3 font-semibold text-white">View Instagram</a>
              </div>
            </div>

            <div className="rounded-[1.75rem] bg-white p-6 text-zinc-900">
